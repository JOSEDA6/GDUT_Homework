...
export COMET_MAX_IMAGE_UPLOADS=NUMBER                       # Max prediction image to log. Default: 100
...
train: image/train # Adjust subdirectory if needed
val: image/val # Adjust subdirectory if needed
