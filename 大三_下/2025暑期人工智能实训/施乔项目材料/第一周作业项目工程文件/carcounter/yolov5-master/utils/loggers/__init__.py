...
class Loggers:
    ...
    def on_train_batch_end(self, model, ni, imgs, targets, paths, vals):
        """Logs training batch end events, plots image, and updates external loggers with batch-end data."""
...
class GenericLogger:
    ...
    def log_images(self, files, name="Images", epoch=0):
        """Logs image to all loggers with optional naming and epoch specification."""
