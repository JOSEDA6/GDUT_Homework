...
class LoadImagesAndLabelsAndMasks(LoadImagesAndLabels):  # for training/testing
    """Loads image, labels, and segmentation masks for training and testing YOLO models with augmentation support."""
    ...
    def load_mosaic(self, index):
        """Loads 1 image + 3 random image into a 4-image YOLOv5 mosaic, adjusting labels and segments accordingly."""
        labels4, segments4 = [], []
        s = self.img_size
    ...
    def collate_fn(batch):
        """Custom collation function for DataLoader, batches image, labels, paths, shapes, and segmentation masks."""
