...
def plot_labels(labels, names=(), save_dir=Path("")):
    """Plots dataset labels, saving correlogram and label image, handles classes, and visualizes bounding boxes."""
...
def imshow_cls(im, labels=None, pred=None, names=None, nmax=25, verbose=False, f=Path("image.jpg")):
    """Displays a grid of image with optional labels and predictions, saving to a file."""
