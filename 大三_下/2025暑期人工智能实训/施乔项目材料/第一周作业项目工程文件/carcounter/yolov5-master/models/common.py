...
class DetectMultiBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False):
        """Performs YOLOv5 inference on input image with options for augmentation and visualization."""
...
class AutoShape(nn.Module):
    ...
    def forward(self, ims, size=640, augment=False, profile=False):
        ...
        """
        # For size(height=640, width=1280), RGB image example inputs are:
...
class Detections:
    ...
    def render(self, labels=True):
        """Renders detection results with optional labels on image; args: labels (bool) indicating label inclusion."""
