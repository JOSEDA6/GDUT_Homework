...
class iOSModel(torch.nn.Module):
    """An iOS-compatible wrapper for YOLOv5 models that normalizes input image based on their dimensions."""
    ...
    def __init__(self, model, im):
        ...
        Args:
            ...
            im (torch.Tensor): An input tensor representing a batch of image with shape (B, C, H, W).
